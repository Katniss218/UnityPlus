...
namespace UnityPlus.Serialization
{
    ...
    public class ReflectionFieldInfo : IMemberInfo
    {
        ...
        private Getter<object, object> _getter;
        private Setter<object, object> _setter; // For classes
        ...
        public ReflectionFieldInfo( FieldInfo field )
        {
            ...
            _getter = Expression.Lambda<Getter<object, object>>( castResult, targetParam ).Compile();
            ...
            else
            {
                ...
                _setter = Expression.Lambda<Setter<object, object>>( assign, targetParam, valueParam ).Compile();
            }
        }
