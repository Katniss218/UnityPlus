...
namespace UnityPlus.Serialization
{
    ...
    /// </summary>
    public static partial class SerializationUnitV4
    {
#warning TODO - rename to SerializationUnit after merging and the old one is removed.
        // --- Serialize ---
        ...
        public static SerializedData Serialize<T>( int context, T obj, IReverseReferenceMap s )
        {
            ...
            driver.Initialize( obj, descriptor, new SerializerStrategy() );
        ...
        public static T Deserialize<T>( int context, SerializedData data, IForwardReferenceMap l )
        {
            ...
            driver.Initialize( null, descriptor, new DeserializerStrategy(), data );
        ...
        public static void Populate<T>( int context, T obj, SerializedData data, IForwardReferenceMap l ) where T : class
        {
            ...
            driver.Initialize( obj, descriptor, new DeserializerStrategy(), data );
