...
{
    /// <summary>
    /// Maps context marker types to unique integer IDs.
    /// Handles backward compatibility with v3 fixed integers and dynamic generation for generic combinations.
    /// </summary>
    public static class ContextRegistry
    {
        ...
        /// <summary>
        /// Gets an ID for a dictionary combination. If it doesn't exist, mints one and notifies TypeDescriptorRegistry.
        /// </summary>
        public static int GetOrRegisterDictionaryContext( int keyContextId, int valueContextId, Type sourceContextType = null )
        {
            ...
            if( !_dictionaryCombinations.TryGetValue( key, out int id ) )
            {
                ...
                // Tell the Serializer how to handle this new ID
                TypeDescriptorRegistry.RegisterDictionaryContext( id, keyContextId, valueContextId );
            }
        ...
        /// <summary>
        /// Gets an ID for a collection (List/Array) combination. If it doesn't exist, mints one and notifies TypeDescriptorRegistry.
        /// </summary>
        public static int GetOrRegisterCollectionContext( int elementContextId, Type sourceContextType = null )
        {
            ...
            if( !_collectionCombinations.TryGetValue( elementContextId, out int id ) )
            {
                ...
                // Tell the Serializer how to handle this new ID
                TypeDescriptorRegistry.RegisterCollectionContext( id, elementContextId );
            }
