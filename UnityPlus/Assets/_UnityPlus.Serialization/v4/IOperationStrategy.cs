...
namespace UnityPlus.Serialization
{
    public interface IOperationStrategy
    {
        ...
        /// </summary>
        void InitializeRoot( object root, ITypeDescriptor descriptor, SerializedData data, SerializationState state );

        /// <summary>
        /// Processes the current cursor.
        /// </summary>
        StepResult Process( ref SerializationCursor cursor, SerializationState state );
