...
{
    /// <summary>
    /// A slider allows you to select between a range of possible input values.
    /// </summary>
    /// <typeparam name="TValue">The type of the outputted value.</typeparam>
    public partial class UIInputSlider<TValue> : UIElement, IUIInputElement<TValue>, IUIElementChild
    {
